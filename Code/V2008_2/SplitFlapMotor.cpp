...
void SplitFlapMotor::begin() {
    ...
    stepper.setMaxSpeed(600); //was 800
    stepper.setAcceleration(200);  //was 400
...
void SplitFlapMotor::resetConfig() {
  ...
  config.setZeroOffset(91);  // Default zero offset
  config.setStepOffset(0);   // Optional: you can omit this if you prefer
...
void SplitFlapMotor::setZeroOffsetDegrees(long offset) {
    ...
    config.setZeroOffset(offset);  // <-- Store persistently
...
void SplitFlapMotor::setStepOffset(long offset) {
    ...
    stepOffset = offset;
    config.setStepOffset(offset);  // <-- Store persistently
...
void SplitFlapMotor::setZeroOffsetDegreesInteractive() {
  ...
  if (response == 'y' || response == 'Y') {
    ...
    config.setZeroOffset(zeroOffsetDegrees);  // <-- Save persistently
...
void SplitFlapMotor::setStepOffsetInteractive() {
  ...
  if (response == 'y' || response == 'Y') {
    ...
    config.setStepOffset(stepOffset);  // <-- Save persistently
...
void SplitFlapMotor::printInfo() {
  ...
  config.print(); // Print config values
