...
class SplitFlapMotor {
  public:
    ...
    void setZeroOffsetSteps(long steps); // updated name
    void setZeroOffsetStepsInteractive(); // updated name
    ...
    // Module-to-left listening toggle
    void setModuleListening(bool enabled);
    bool isModuleListeningFromLeft();

    // Moved to public for use in .ino
